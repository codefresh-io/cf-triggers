...
func setupRouter(eventReaderWriter model.TriggerEventReaderWriter,
	...
	runnerController := controller.NewRunnerController(runner, publisher, eventReaderWriter, triggerReaderWriter)
	{
...
func runServer(c *cli.Context) error {
	...
	// setup router
	router := setupRouter(triggerBackend, triggerBackend, eventProvider, runner, publisher, triggerBackend, codefreshService)
